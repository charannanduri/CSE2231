...
public abstract class ListTest {
    ...
    public final void testRetreatLeftOneRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "blue", "green",
                "yellow", "red");
        List<String> list2 = this.createFromArgsRef(0, "blue", "green",
                "yellow", "red");
    ...
    public final void testRetreatLeftMultipleRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "blue", "green",
                "yellow");
        List<String> list2 = this.createFromArgsRef(2, "blue", "green",
                "yellow");
        /*
         * Call method under test
         */
    ...
    public final void testRetreatLeftMultipleRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "blue", "green",
                "yellow", "red");
        List<String> list2 = this.createFromArgsRef(1, "blue", "green",
                "yellow", "red");
        /*
         * Call method under test
         */
