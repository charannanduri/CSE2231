 ...
 * </pre>
 *
 * @author Evan Frisbie, Charan Nanduri, Sarina Mathis
 *
 */
public class List3<T> extends ListSecondary<T> {
    ...
    public final T removeRightFront() {
        ...
        Node n2 = lastleft.next;
        T val = n2.data;
        // remove node and relink
        Node n3 = n2.next;
    ...
    public final void advance() {
        ...
        // TODO - fill in body
        // LastLeft is like our focus node. So we want to move our focus to the
        // next value which we get from our right side list. So pull one from
        // the right and add to left

        // Redirect the pointer
        this.lastLeft = this.lastLeft.next;

        // Adjust the lengths of both lists
        this.rightLength--;
        this.leftLength++;
    ...
    public final void moveToStart() {
        ...
        // TODO - fill in body
        // Here we are moving our focus value, lastLeft, to the front of the
        // list

        // Move our pointer to the front
        this.lastLeft = this.preStart;

        // The right length is all the values
        this.rightLength = this.leftLength + this.rightLength;

        // Now the left Length is 0
        this.leftLength = 0;
    ...
    public final void moveToFinish() {
        ...
        // TODO - fill in body
        // Here we are moving our focus to the end and putting all values in the
        // left list

        // Move the pointer to the one before the last one since we are still in
        // the left list and there will still be a value, lastLeft has to have a
        // Value

        // Adjust the left length
        this.leftLength = this.rightLength + this.leftLength;

        // The right length is now the one that is zero
        this.rightLength = 0;
    ...
    public final void retreat() {
        ...
        // TODO - fill in body
        this.lastLeft.next = this.lastLeft;

        // Here, we are going right to left. So LastLeft -> lastLeft.previous
