...
public class Statement2 extends StatementSecondary {
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        // TODO - fill in body
        Statement2 a = (Statement2) s; //casting s to a
        this.rep.addSubtree(pos, a.rep); // makes 'a' a subtree at pos in rep
        a.createNewRep(); // makes a new rep for a
    }
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        // TODO - fill in body
        Sequence<Tree<StatementLabel>> c = this.rep.newSequenceOfTree(); //children
        StatementLabel r = this.rep.disassemble(c); //root
        s.rep = c.remove(pos); //remove child
        this.rep.assemble(r, c); //reassemble
